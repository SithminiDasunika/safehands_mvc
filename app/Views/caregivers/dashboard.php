...
<header class="top-nav-bar">
    <nav class="top-nav-inner">
        ...
        <div class="nav-logo-area">
            ...
            <a href="/safehands_mvc/caregiver/dashboard" class="nav-logo">
                SafeHands
            </a>
        ...
        <div class="nav-actions">
            ...
            <a href="/safehands_mvc/caregiver/emergencyContact"
               class="icon-btn emergency-call-btn"
...
<main class="main-content">
    ...
    <header class="greeting-header">
        ...
        <div>
            <h1 class="greeting-title">
                Good Morning, <?= htmlspecialchars($caregiverName) ?> 👋
            </h1>

            <p class="greeting-subtitle">
                Manage your daily care schedule, bookings and earnings from one place.
            </p>
        </div>
    ...
    <div class="quick-action-grid">
        ...
        <!-- Pending Reports -->
        <a href="/safehands_mvc/caregiver/pendingReports"
           class="quick-action-card">
            ...
            <div class="card">
                ...
                <div class="report-list">
                    ...
                    <div class="report-item">
                        ...
                        <button
                            class="btn-report"
                            onclick="window.location.href='/safehands_mvc/caregiver/schedule'">
                ...
                <div class="notif-list">
                    ...
                    <div class="notif-item border-b">
                        ...
                        <div>
                            ...
                            <p class="notif-desc">
                                Your earnings for last week have been released.
                            </p>
                    ...
                    <div class="notif-item">
                        ...
                        <div>
                            ...
                            <p class="notif-desc">
                                Mr. Perera requested a session for Oct 30.
                            </p>
            ...
            <div class="support-card">
                ...
                <div class="support-content">
                    ...
                    <p class="support-desc">
                        Our support team is available 24/7 to help you with your care services.
                    </p>
